...
public class Constants {
	...
	// FormRecognizer Constants
	private static Properties formRecProperties = PropertyInitiator.objectReturn("FormRecognizer");
	public static String FORM_REC_URL = formRecProperties.getProperty("formRecognizerUrl");
